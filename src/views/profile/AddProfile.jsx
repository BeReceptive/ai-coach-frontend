        ...
        <div className="add-profile">
          <main>
            <header className="border-b border-white/5">
              ...
              <nav className="flex overflow-x-auto py-4 border-solid border-b border-gray-100 border-opacity-1">
                <ul
                  role="list"
              ...
              <div className="grid max-w-7xl grid-cols-1 gap-x-8 gap-y-10 px-4 py-16 sm:px-6 md:grid-cols-3 lg:px-8">
                ...
                <form className="md:col-span-2">
                  <div className="grid grid-cols-1 gap-x-6 gap-y-8 sm:max-w-xl sm:grid-cols-6">
                    ...
                    {/*                              className="flex-1 border-0 bg-transparent py-1.5 pl-1 text-white focus:ring-0 sm:text-sm sm:leading-6 bg-red"*/}
                  ...
                  <div className="mt-8 flex">
                    <button
                      type="submit"
                      className="rounded-md bg-gray-900 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-gray-800 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500"
                    >
                      Save
                    </button>
                  </div>
